...
<html>
  ...
  <body>
        ...
        <div class="form-group">
          <div class="input-group input-group-md">
            ...
            <div class="input-group-btn">
              <button type="button" class="btn btn-default" @click="search()" v-if="!loading">Search</button>
                <button type="button" class="btn btn-default" disabled="disabled" v-if="loading">Searching</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/vue-resource/1.0.1/vue-resource.min.js"></script>
